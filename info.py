...
API_ID = int(environ.get('API_ID', '12333972'))
API_HASH = environ.get('API_HASH', 'a0f38ec8c608cc7011f563661580bdfe')
BOT_TOKEN = environ.get('BOT_TOKEN', "6849923132:AAH053hdhTEdn8tY9Jkm0KqTleG_EBLQnQ4")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1145706681').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '0').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1145706681').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://SaitamaUserbot:<UserBOTG>@cluster0.xm3uhaj.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '2049792549'))
